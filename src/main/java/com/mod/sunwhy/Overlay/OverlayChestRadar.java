...
public class OverlayChestRadar extends Gui {
    ...
    private String show;
    final ResourceLocation bg = new ResourceLocation("lezinkmod", "textures/overlay/chest_radar.png");
    ...
    public void onRender(RenderGameOverlayEvent.Post event) {
        ...
        if ((this.mc.thePlayer.getHeldItem() != null)
                && ((this.mc.thePlayer.getHeldItem().getItem() instanceof UnclaimFinder))
