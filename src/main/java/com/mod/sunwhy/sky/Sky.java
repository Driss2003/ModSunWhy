...
public class Sky extends IRenderHandler
{
...
mc.getTextureManager().bindTexture(new ResourceLocation(Reference.MOD_ID , "/textures/meteo/sun.png"));
...
mc.getTextureManager().bindTexture(new ResourceLocation(Reference.MOD_ID , "/textures/meteo/moon.png"));
