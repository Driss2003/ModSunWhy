...
public class PortalSaphir
{
    ...
    public PortalSaphir(WorldServer p_i1963_1_)
    {
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        int i2 = k + i1 * b1 - l * b0;
                        boolean flag = j1 < 0;
                        this.worldServerInstance.setBlock(k1, l1, i2, flag ? BlockMod.myleniumblock : Blocks.air);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
    {
        ...
        {
            PortalSaphir.PortalPosition portalposition = (PortalSaphir.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new PortalSaphir.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                PortalSaphir.PortalPosition portalposition = (PortalSaphir.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
